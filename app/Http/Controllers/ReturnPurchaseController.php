        ...
        public function store(Request $request)
        {
            ...
            foreach ($product_id as $key => $pro_id) {
                ...
                PurchaseProductReturn::insert(
                    ['return_id' => $lims_return_data->id, 'product_id' => $pro_id, 'imei_number' => $imei_number[$key], 'product_batch_id' => $product_batch_id[$key], 'variant_id' => $variant_id, 'qty' => $qty[$key], 'purchase_unit_id' => $purchase_unit_id, 'net_unit_cost' => $net_unit_cost[$key], 'discount' => $discount[$key], 'tax_rate' => $tax_rate[$key], 'tax' => $tax[$key], 'total' => $total[$key], 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()]
                );
            }
