<?php
    ...
    class SettingController extends Controller
    {
        ...
        public function generalSettingStore(Request $request)
        {
            ...
            $replaceArray = ['APP_TIMEZONE=' . $data['timezone']];
        ...
        public function mailSettingStore(Request $request)
        {
            ...
            $path        = base_path() . '/.env';
            $searchArray = ['MAIL_HOST="' . env('MAIL_HOST') . '"', 'MAIL_PORT=' . env('MAIL_PORT'), 'MAIL_FROM_ADDRESS="' . env('MAIL_FROM_ADDRESS') . '"', 'MAIL_FROM_NAME="' . env('MAIL_FROM_NAME') . '"', 'MAIL_USERNAME="' . env('MAIL_USERNAME') . '"', 'MAIL_PASSWORD="' . env('MAIL_PASSWORD') . '"', 'MAIL_ENCRYPTION="' . env('MAIL_ENCRYPTION') . '"'];
            //return $searchArray;

            $replaceArray = ['MAIL_HOST="' . $data['mail_host'] . '"', 'MAIL_PORT=' . $data['port'], 'MAIL_FROM_ADDRESS="' . $data['mail_address'] . '"', 'MAIL_FROM_NAME="' . $data['mail_name'] . '"', 'MAIL_USERNAME="' . $data['mail_address'] . '"', 'MAIL_PASSWORD="' . $data['password'] . '"', 'MAIL_ENCRYPTION="' . $data['encryption'] . '"'];
        ...
        public function smsSettingStore(Request $request)
        {
            ...
            if ($data['gateway'] == 'twilio') {
                $searchArray = ['SMS_GATEWAY=' . env('SMS_GATEWAY'), 'ACCOUNT_SID=' . env('ACCOUNT_SID'), 'AUTH_TOKEN=' . env('AUTH_TOKEN'), 'TWILIO_NUMBER=' . env('TWILIO_NUMBER')];

                $replaceArray = ['SMS_GATEWAY=' . $data['gateway'], 'ACCOUNT_SID=' . $data['account_sid'], 'AUTH_TOKEN=' . $data['auth_token'], 'TWILIO_NUMBER=' . $data['TWILIO_NUMBER']];
            } else {
                $searchArray  = ['SMS_GATEWAY=' . env('SMS_GATEWAY'), 'CLICKATELL_API_KEY=' . env('CLICKATELL_API_KEY')];
                $replaceArray = ['SMS_GATEWAY=' . $data['gateway'], 'CLICKATELL_API_KEY=' . $data['api_key']];
            }
        ...
        public function posSettingStore(Request $request)
        {
           ...
           $path         = base_path() . '/.env';
            $searchArray = ['PAYPAL_LIVE_API_USERNAME=' . env('PAYPAL_LIVE_API_USERNAME'), 'PAYPAL_LIVE_API_PASSWORD=' . env('PAYPAL_LIVE_API_PASSWORD'), 'PAYPAL_LIVE_API_SECRET=' . env('PAYPAL_LIVE_API_SECRET')];

            $replaceArray = ['PAYPAL_LIVE_API_USERNAME=' . $data['paypal_username'], 'PAYPAL_LIVE_API_PASSWORD=' . $data['paypal_password'], 'PAYPAL_LIVE_API_SECRET=' . $data['paypal_signature']];
