                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <button type="button" data-id="{{$expense_category->id}}"
                                                ...
                                                data-target="#editModal"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}
                                        </button>
                                    </li>
                                    <li class="divider"></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="/sample_file/sample_expense_category.csv" class="btn btn-info btn-block btn-md"><i
