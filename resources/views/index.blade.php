                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              @endif
                              <td>{{number_format($quotation->grand_total)}}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{$key + 1}}</td>
                          <td>{{$product->name}}</td>
                          <td>{{number_format((float)$sale->total_price)}}</td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
...
<script type="text/javascript">
    ...
    function dashboardFilter(data){
        $('.revenue-data').hide();
        $('.revenue-data').html(parseFloat(data[0]).toLocaleString('en-US'));
        $('.revenue-data').show(500);

        $('.return-data').hide();
        $('.return-data').html(parseFloat(data[1]).toLocaleString('en-US'));
        $('.return-data').show(500);

        $('.profit-data').hide();
        $('.profit-data').html(parseFloat(data[2]).toLocaleString('en-US'));
        $('.profit-data').show(500);

        $('.purchase_return-data').hide();
        $('.purchase_return-data').html(parseFloat(data[3]).toLocaleString('en-US'));
