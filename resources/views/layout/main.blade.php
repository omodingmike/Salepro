...
{{--    <link rel="preload" href="https://cdn.datatables.net/fixedheader/3.1.6/css/fixedHeader.bootstrap.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">--}}
          <link rel="stylesheet" href="{{asset('vendor/datatable/fixedHeader.bootstrap.min.css')}}">
                ...
                @if($product_qty_alert_active)
                  ...
                  <li class="nav-item" id="notification-icon">
                        <a rel="nofollow" data-toggle="tooltip" title="{{__('Notifications')}}" class="nav-link dropdown-item"><i
                                    class="dripicons-bell"></i><span class="badge badge-danger notification-number">{{$alert_product +
                                    count(\Auth::user()->unreadNotifications)}}</span>
                        </a>
                        <ul class="right-sidebar">
                            <li class="notifications">
                              <a href="{{route('report.qtyAlert')}}" class="btn btn-link"> {{$alert_product}}  @if($alert_product>1)
                                      products exceed
                                  @else product exceeds @endif alert quantity
                                  </a>
                            </li>
...
{{--    <script type="text/javascript" src="https://cdn.datatables.net/fixedheader/3.1.6/js/dataTables.fixedHeader.min.js"></script>--}}
    ...
    <script src="{{asset('vendor/datatable/dataTables.fixedHeader.min.js')}}"></script>
...
{{--    <script type="text/javascript" src="https://cdn.datatables.net/responsive/2.2.3/js/responsive.bootstrap.min.js"></script>--}}
    ...
    <script src="{{asset('vendor/datatable/responsive.bootstrap.min.js')}}"></script>
    @endif
    @stack('scripts')
    <script>
