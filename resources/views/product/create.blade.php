                            ...
                            <form id="product-form">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="code" class="form-control" id="code" aria-describedby="code"
                                                       required value="{{\App\Helpers\Functions::generateCode()}}">
                                    ...
                                    <div id="digital" class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Attach File')}} <strong>*</strong> </label>
                                            <div class="input-group">
...
{{--                                            </select>--}}
                                    ...
                                    <div class="col-md-12 mt-2 hidden" id="diffPrice-option">
                                    ...
                                    <div class="col-md-6 hidden" id="diffPrice-section">
