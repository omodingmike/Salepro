                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Product Type')}}<strong> *</strong> </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="code" id="code" value="{{$lims_product_data->code}}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Barcode Symbology')}} <strong>*</strong> </label>
                                            <div class="input-group">
                                    ...
                                    <div id="unit" class="col-md-12">
                                        <div class="row ">
                                            <div class="col-md-4">
                                                <label>{{trans('file.Product Unit')}} <strong>*</strong> </label>
                                                <div class="input-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Product Price')}} <strong>*</strong> </label>
                                    ...
                                    <div id="alert-qty" class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="alert_quantity" value="{{$lims_product_data->alert_quantity}}"
                                                   class="form-control" step="any">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{trans('file.Product Image')}}</strong> </label> <i class="dripicons-question"
                                                                                                        data-toggle="tooltip"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                @php $images = explode(",", $lims_product_data->image)@endphp
                                                @foreach($images as $key => $image)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="{{url('images/product', $image)}}" height="60" width="60" alt="fff">
                                            ...
                                            <table id="diffPrice-table" class="table table-hover">
                                                ...
                                                @foreach($lims_warehouse_list as $warehouse)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                $product_warehouse = \App\Product_Warehouse::FindProductWithoutVariant
                                    ...
                                    <div class="col-md-12 mt-3" id="batch-option">
                                        @if($lims_product_data->is_batch)
                                            <h5><input name="is_batch" type="checkbox" id="is-batch" value="1"
                                                       checked>&nbsp; {{trans('file.This product has batch and expired date')}}</h5>
                                        @else
                                            <h5><input name="is_batch" type="checkbox" id="is-batch"
                                                       value="1">&nbsp; {{trans('file.This product has batch and expired date')}}</h5>
                                        @endif
                                    </div>
                                    <div class="col-md-12 mt-3" id="imei-option">
                                        @if($lims_product_data->is_imei)
                                            <h5><input name="is_imei" type="checkbox" id="is-imei" value="1"
                                                       checked>&nbsp; {{trans('file.This product has IMEI or Serial numbers')}}</h5>
                                        @else
                                            <h5><input name="is_imei" type="checkbox" id="is-imei"
                                                       value="1">&nbsp; {{trans('file.This product has IMEI or Serial numbers')}}</h5>
                                        @endif
                                    </div>
                                            ...
                                            <table id="variant-table" class="table table-hover variant-list">
                                                ...
                                                @foreach($lims_product_variant_data as $key=> $variant)
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="form-control" name="variant_name[]"
                                                                   value="{{$variant->name}}"/></td>
                                                        <td><input type="text" class="form-control" name="item_code[]"
                                                                   value="{{$variant->pivot['item_code']}}"/></td>
                                                        <td><input type="number" class="form-control" name="additional_price[]"
                                                                   value="{{$variant->pivot['additional_price']}}" step="any"/></td>
                                                        <td>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-4" id="promotion_price"><label>{{trans('file.Promotional Price')}}</label>
                                                <input type="number" name="promotion_price" value="{{$lims_product_data->promotion_price}}"
                                                       class="form-control" step="any"/>
                                            </div>
                                            <div id="start_date" class="col-md-4">
                                                <div class="form-group">
                                                    <label>{{trans('file.Promotion Starts')}}</label>
                                                    <input type="text" name="starting_date" value="{{$lims_product_data->starting_date}}"
                                            ...
                                            <div id="last_date" class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="last_date" value="{{$lims_product_data->last_date}}"
