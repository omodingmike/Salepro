                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <p>{{trans('file.The correct column order is')}} (product_code, quantity, purchase_unit,
                                                    product_cost, discount, tax_name) {{trans('file.and you must follow this')}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="..//sample_file/sample_purchase_products.csv"
                                                   class="btn btn-primary btn-block btn-lg"><i
                                                            class="dripicons-download"></i> {{trans('file.Download Sample File')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
