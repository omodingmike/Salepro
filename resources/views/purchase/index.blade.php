    ...
    <section>
        <div class="container-fluid">
            ...
            @if(in_array("purchases-add", $all_permission))
                <a href="{{route('purchases.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Add Purchase')}}
                </a>&nbsp;
...
@push('scripts')
    <script type="text/javascript">
        ...
        var public_key = ' ';
        var all_permission = @php echo json_encode($all_permission)@endphp;
