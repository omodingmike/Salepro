                                            ...
                                            <div class="form-group">
                                                ...
                                                <select required name="customer_id" class="selectpicker form-control"
                                                    ...
                                                    @foreach($lims_customer_list as $customer)
                                                        <?php use App\ProductBatch;use App\ProductVariant;$deposit[$customer->id] = $customer->deposit - $customer->expense; ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <div class="search-box input-group">
                                                <button type="button" class="btn btn-secondary btn-lg"><i class="fa fa-barcode"></i>
                                                </button>
                                                    ...
                                                    @foreach($lims_product_quotation_data as $product_quotation)
                                                        <tr>
                                                            ...
                                                            if ($product_quotation->variant_id) {
                                                                $product_variant_data = ProductVariant::select('item_code')->FindExactProduct($product_quotation->product_id, $product_quotation->variant_id)->first();
                                                            ...
                                                            $product_batch_data = ProductBatch::select('batch_no')->find($product_quotation->product_batch_id);
                                                            ?>
