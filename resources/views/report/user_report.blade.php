                    ...
                    <table id="sale-table" class="table table-hover">
                        ...
                        @foreach($lims_sale_data as $key=>$sale)
                            <tr>
                                ...
                                <td>{{number_format((float) $sale->grand_total)}}</td>
                                @if($sale->paid_amount)
                                    <td class="paid-amount">{{number_format((float) $sale->paid_amount)}}</td>
                                @else
                                    <td>0.00</td>
                                @endif
                                <td>{{number_format((float)($sale->grand_total - $sale->paid_amount))}}</td>
                    ...
                    <table id="purchase-table" class="table table-hover">
                        ...
                        @foreach($lims_purchase_data as $key=>$purchase)
                            <tr>
                                ...
                                <td>{{number_format((float)($purchase->grand_total))}}</td>
                                <td>{{number_format((float)($purchase->paid_amount))}}</td>
                                <td>{{number_format((float)($purchase->grand_total - $purchase->paid_amount))}}</td>
                    ...
                    <table id="quotation-table" class="table table-hover">
                        ...
                        @foreach($lims_quotation_data as $key=>$quotation)
                            <tr>
                                ...
                                <td>{{number_format((float) $quotation->grand_total)}}</td>
                    ...
                    <table id="transfer-table" class="table table-hover">
                        ...
                        @foreach($lims_transfer_data as $key=>$transfer)
                            <tr>
                                ...
                                <td>{{number_format((float) $transfer->grand_total)}}</td>
