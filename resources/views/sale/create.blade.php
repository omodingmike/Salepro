                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="order_tax_rate" value="0.0" id="" hidden>
                                    {{--                                    <div class="row mt-3">--}}
                                    {{--                                        <div class="col-md-4">--}}
                                    {{--                                            <div class="form-group">--}}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group warehouse-section">
                                <label>{{trans('file.Warehouse')}} <strong> *</strong></label>
                            ...
                            <div class="col-md-6 form-group">
                                <label>{{trans('file.Cash in Hand')}} <strong> *</strong></label>
