...
{{--                            </div>--}}
                            ...
                            {{--                                <div class="column-5">--}}
                            {{--                                    <button style="background-color: #319398" type="button" class="btn btn-custom payment-btn"--}}
                            ...
                            <div class="column-5">
                                <button style="background-color: #ffc107;" type="button" class="btn btn-custom" data-toggle="modal"
                                        data-target="#recentTransaction"><i
                                        ...
                                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                            ...
                                            <li class="nav-item">
                                                <a href="" id="register-details-btn" data-toggle="tooltip"
                                                   title="{{trans('file.Cash Register Details')}}"><i class="dripicons-briefcase"></i></a>
                                            </li>
                                            <?php
                                            ...
                                            @if($today_sale_permission_active)
                                                <li class="nav-item">
                                                    <a href="" id="today-sale-btn" data-toggle="tooltip"
                                                       title="{{trans('file.Today Sale')}}"><i class="dripicons-shopping-bag"></i></a>
                                                </li>
                                            @endif
                                            @if($today_profit_permission_active)
                                                <li class="nav-item">
                                                    <a href="" id="today-profit-btn" data-toggle="tooltip"
                                                       title="{{trans('file.Today Profit')}}"><i class="dripicons-graph-line"></i></a>
                                                </li>
                                            @endif
                                            ...
                                            @endif
                                            <li class="nav-item">
                                                <a class="dropdown-item" data-toggle="tooltip" title="{{trans('file.Help')}}"
                                                   href="{{ url('/read_me') }}" target="_blank"><i class="dripicons-information"></i></a>
                                            </li>&nbsp;
                                            <li class="nav-item">
...
@push('scripts')
  ...
  localStorage.setItem("localStorageQty", localStorageQty);*/
        ...
        function change(paying_amount, paid_amount) {
            $("#change").text(parseFloat(paying_amount - paid_amount).toLocaleString('en-US'));
        }
